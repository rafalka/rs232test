...
bool QSerialPortPrivate::setTimeout(long millisec)
{
    ...
    if (millisec == -1) {
        ...
        currentCommTimeouts.ReadIntervalTimeout = millisec;
        currentCommTimeouts.ReadTotalTimeoutConstant = 250;
        currentCommTimeouts.ReadTotalTimeoutMultiplier = 0;
        currentCommTimeouts.WriteTotalTimeoutMultiplier = millisec;
...
long QSerialPortPrivate::getTimeout() const
{
    return (long) currentCommTimeouts.ReadIntervalTimeout;
}
